...
public class Waits {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(wait.until(ExpectedConditions.elementSelectionStateToBe(By.xpath("//input[@value='option-2']"), true)));
		System.out.println(wait.until(ExpectedConditions.elementSelectionStateToBe(driver.findElement(By.xpath("//input[@value='option-3']")), false)));
		...
		System.out.println(wait.until(ExpectedConditions.elementToBeSelected(driver.findElement(By.xpath("//input[@value='option-2']")))));
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter your active Email ID / Username']")).sendKeys("arc@gmail.com");
//		wait.until(ExpectedConditions.textToBePresentInElementValue(By.name(""), ""));
		System.out.println(wait.until(ExpectedConditions.textToBePresentInElementValue(driver.findElement(By.xpath("//input[@placeholder='Enter your active Email ID / Username']")), "arc@gmail.com")));
